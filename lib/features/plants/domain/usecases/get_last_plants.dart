...
/// Use case for getting last plants
class GetLastPlants implements UseCase<List<Plants>, Params> {
  /// Constructor for GetLastPlants
  GetLastPlants({required this.repository});
